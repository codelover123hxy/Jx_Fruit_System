...
public class AjaxResult<T> {
    ...
    public static <N> AjaxResult<N> ERROR() { return new AjaxResult<>(ResponseCode.ERROR.getCode(), "fail", null); }

    public static <N> AjaxResult<N> ERROR(N data) { return new AjaxResult<>(ResponseCode.ERROR.getCode(), "fail", data); }

    public static <N> AjaxResult<N> ERROR(String msg, N data) { return new AjaxResult<>(ResponseCode.ERROR.getCode(), msg, data); }
